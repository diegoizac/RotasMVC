        ...
        public IEnumerable<Noticia> TodasAsNoticias()
        {
            var retorno = new Collection<Noticia>
            {
                ...
                new Noticia
                {
                    ...
                    Conteudo = "O comediante mais engraçado do Youtube fará show hoje...",
                ...
                new Noticia
                {
                    NoticiaId = 7,
                    Categoria = "Esportes",
                    Titulo = "Atacante do Galo faz 4 gols",
                    Conteudo = "O atacante Ronaldinho Gaucho, fez 4 gols e decidiu o título...",
